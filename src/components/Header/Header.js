    ...
    <Div1>
      <Link href="/">
        <a style={{ display: 'flex', alignItems: 'center', color: "white" }}>
          <img src="/images/portfolio_bg.png" style={{objectFit:'cover'}} height={40} width={40} /> <span style={{ marginLeft: 10, marginTop: 7, fontSize: 20 }} >Tule Simon</span>
        </a>
      </Link>
    </Div1>
    <Div2>
      ...
      <li>
        <a href="https://xblog-tulesimon.vercel.app/">
